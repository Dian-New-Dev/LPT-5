...
const sobre = {
    img: 'images/foto.png',
    h2: 'Sobre Mim',
    p1: 'Olá! Meu nome é Jéssica Silva, sou psicóloga especializada em terapia cognitivo-comportamental (TCC) e possuo mais de 10 anos de experiência ajudando pessoas a superar desafios emocionais e psicológicos. Minha missão é proporcionar um espaço seguro e acolhedor onde meus pacientes possam explorar suas emoções, desenvolver habilidades de enfrentamento e encontrar um caminho para uma vida mais equilibrada e satisfatória.',
    p2: 'Com uma abordagem personalizada, busco entender as necessidades individuais de cada pessoa, oferecendo suporte contínuo e estratégias eficazes para promover mudanças positivas. Seja para lidar com ansiedade, depressão, estresse ou outros problemas emocionais, estou aqui para ajudar você a alcançar seu bem-estar e crescimento pessoal.',
...
const FAQ = {
    ...
    h3: [
        'Quais são as modalidades de atendimento oferecidas?',
    ...
    respostas: [
        ...
        'Sim, todas as sessões de terapia são completamente confidenciais. Asseguro a privacidade e a confidencialidade de todas as informações compartilhadas, seguindo as diretrizes éticas e profissionais estabelecidas pelo Conselho Federal de Psicologia.',
    ]
